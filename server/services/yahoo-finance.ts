...
const SYMBOL_MAPPINGS = {
  ...
  // Currencies
  'THBUSD=X': { name: 'Thai Baht', type: 'currency' as const, unit: 'THB per USD', pair: 'THB/USD' },
  'MYRUSD=X': { name: 'Malaysian Ringgit', type: 'currency' as const, unit: 'MYR per USD', pair: 'MYR/USD' },
